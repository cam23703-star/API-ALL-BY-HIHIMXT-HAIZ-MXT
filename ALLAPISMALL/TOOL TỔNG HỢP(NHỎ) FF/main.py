...
def draw_header(subtitle=""):
   ...
   ╚═╝  ╚═╝ ╚═╝  ╚═╝ ╚═╝  ╚═╝ ╚═╝      ╚═╝  ╚═╝    ╚═╝   {Colors.END}"""
    ...
    print(f"{Colors.MAGENTA}●{'═' * 15} {Colors.WHITE}{Colors.BOLD}ARAFAT BIND TOOL {Colors.END}{Colors.MAGENTA}{'═' * 15}●{Colors.END}\n")
    
    print(f" {Colors.GREEN}⊛ DEVELOPER : {Colors.WHITE} @ARAFAT_FLEX{Colors.END}")
...
def owner_details():
    ...
    print(f" \033[96m⊛ Developer Name :\033[0m \033[97mARAFAT RAHMAN\033[0m")
    print(f" \033[96m⊛ Telegram       :\033[0m \033[97m⊛ @ARAFAT_FLEX\033[0m")
    print(f" \033[96m⊛ Channel / Group:\033[0m \033[97mhttps://t.me/ARAFAT_CORE\033[0m")
